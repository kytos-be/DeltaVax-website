...
coord_cartesian(ylim = c(0, 400000000)) +
  scale_color_manual(values =c("#ffa401" ,"#CB0001")) +
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
# Cell Viability
data_cell <- read_excel("./BienDong_data/BienDong_Data.xlsx", 
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
# Total Viable
data_total <- read_excel("./BienDong_data/BienDong_Data.xlsx", 
                      sheet = "Total_Viable")
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
# Diversity
data_div <- read_excel("./BienDong_data/BienDong_Data.xlsx", 
                      sheet = "Diversity")
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
# Growth
data_gro <- read_excel("./BienDong_data/BienDong_Data.xlsx", 
                      sheet = "Growth")
